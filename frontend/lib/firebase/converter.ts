...
export const flightConverter: FirestoreDataConverter<FirestoreFlight> = {
  ...
  fromFirestore(
    ...
    return {
      ...
      departure_timezone: data.departure_timezone,
      arrival_time: data.arrival_time,
      arrival_timezone: data.arrival_timezone,
...
export function flightFromFirestore(firestoreFlight: FirestoreFlight): Flight {
  return {
    ...
    departure_timezone: firestoreFlight.departure_timezone,
    arrival_time: firestoreFlight.arrival_time,
    arrival_timezone: firestoreFlight.arrival_timezone,
...
export function hotelToFirestore(hotel: Hotel): FirestoreHotel {
  return {
    ...
    check_in_time: hotel.check_in_time || '',
    check_in_timezone: hotel.check_in_timezone || undefined,
    check_out_time: hotel.check_out_time || '',
    check_out_timezone: hotel.check_out_timezone || undefined,
...
export function hotelFromFirestore(firestoreHotel: FirestoreHotel): Hotel {
  return {
    ...
    check_in_timezone: firestoreHotel.check_in_timezone,
    check_out_time: firestoreHotel.check_out_time,
    check_out_timezone: firestoreHotel.check_out_timezone,
